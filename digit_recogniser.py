...
#the code is taken from this source: https://www.kaggle.com/vitost/kernel-keras-injection-sol?scriptVersionId=28780969&cellId=3

#Making an injection to keras tenorflow.

def _get_available_gpus():
    """Get a list of available gpu devices (formatted as strings).

    # Returns
        return the avialable GPU'S.
    """
...
#For running this on GPU enabled devices: please uncomment the line below this.    
